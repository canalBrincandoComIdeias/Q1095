...
#define pinDATA 11  //Porta do Arduino em que o pino DIN (data in) do primeiro módulo MAX7219 esta ligado
#define pinCS 10    //Onde o pino CS do primeiro módulo MAX7219 esta ligado
#define pinCLK 13   //Onde o pino CLX (clock) do primeiro módulo MAX7219 esta ligado
